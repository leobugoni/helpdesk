class HelpdesksController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @helpdesk.save
        ...
        format.json { render :show, status: :created, location: @helpdesk }
      else
  ...
  def update
    respond_to do |format|
      if @helpdesk.update(helpdesk_params)
        ...
        format.json { render :show, status: :ok, location: @helpdesk }
      else
  ...
  def destroy
    @helpdesk.destroy
    respond_to do |format|
      format.html { redirect_to helpdesks_url, notice: 'Helpdesk was successfully destroyed.' }
  ...
  private
    ...
    def helpdesk_params
      params.require(:helpdesk).permit(:cachorro, :id_seq, :gato, :valor)
    end
end
